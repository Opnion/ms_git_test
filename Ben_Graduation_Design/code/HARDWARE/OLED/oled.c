...
void OLED_Mune(void)
{
	...
	OLED_ShowCHinese(90, 0, 8);	   // ℃

	OLED_ShowCHinese(0, 2, 2);	// 湿
	OLED_ShowCHinese(18, 2, 3); // 度
	OLED_ShowString(36, 2, ":", 16);
	OLED_ShowChar(72, 2, '.', 16); // 显示ASCII字符
	OLED_ShowCHinese(90, 2, 9);	   //%

	OLED_ShowCHinese(0, 4, 4);	// 重
	OLED_ShowCHinese(18, 4, 5); // 量
	OLED_ShowString(36, 4, ":", 16);

	OLED_ShowCHinese(0, 6, 6);	// 水
	OLED_ShowCHinese(18, 6, 7); // 位
	OLED_ShowCHinese(36, 6, 11); // 开
	OLED_ShowCHinese(54, 6, 12); // 关
