...
{
	OLED_Clear();
	OLED_ShowCHinese(0, 0, 0);	 // 蓝
	OLED_ShowCHinese(18, 0, 1);	 // 牙
	OLED_ShowString(32,0,":",16); //：
	OLED_ShowCHinese(43, 0, 3);	 // 待修改值    开、关

	OLED_ShowCHinese(68, 0, 5);	 // 光
	OLED_ShowCHinese(86, 0, 6);	 // 敏
	OLED_ShowCHinese(104, 0, 2); // ：
	OLED_ShowCHinese(113, 0, 4); // 待修改值     开、关

	OLED_ShowCHinese(0, 6, 10);	 // 音
	OLED_ShowCHinese(18, 6, 11); // 量
	OLED_ShowString(32,6,":",16); //:
	OLED_ShowString(42,6,"5",16); //待修改值        数字
	OLED_ShowCHinese(60, 6, 12); // 档



	OLED_ShowCHinese(0, 3, 7);	 // 超
	OLED_ShowCHinese(18,3, 8);	 // 声
	OLED_ShowCHinese(36,3, 9);	 // 波
