 ...
 * @LastEditTime: 2024-01-28 15:46:36
 * @FilePath: \USERe:\MS_Graduation Design\code\code_3\HARDWARE\BEEP\beep.c
 *
...
void Buzzer_Init()
{
  ...
  GPIO_SetBits(GPIOE, GPIO_Pin_3);   // 开启使能
  GPIO_ResetBits(GPIOE, GPIO_Pin_2); // 开启使能
}
