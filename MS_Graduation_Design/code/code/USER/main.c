 ...
 * @LastEditTime: 2024-02-20 23:47:44
...
int main(void)
{
	...
	//  f_mkdir("0:/Mas_record");			 // 创建该目录
	if (res != FR_EXIST && res != FR_OK) // 发生了错误
	{
		POINT_COLOR = RED; // 画笔颜色：黑色
		Show_Str(30, 150, 220, 240, "SD_ERROR_1!", 16, 0);
		sd_ok = 0;
	}
	else
	{
		Show_Str(30, 150, 220, 240, "SD_RIGHT_1!", 16, 0);
	}
	...
	// {
	// 	Show_Str(30, 170, 220, 240, "Malloc_ERROR!", 16, 0);
	// 	delay_ms(200);
	// 	LCD_Fill(30, 190, 240, 146, WHITE); // 清除显示
	// 	delay_ms(200);
	// }
	// Show_Str(30, 170, 220, 240, "Malloc_RIGHT!", 16, 0);
	// while (OV2640_Init()) // 初始化OV2640
	// {
	// 	Show_Str(30, 190, 220, 240, "OV2640_ERROR!", 16, 0);
	// 	delay_ms(200);
	// 	LCD_Fill(30, 190, 239, 206, WHITE);
	// 	delay_ms(200);
	// }
	// Show_Str(30, 190, 220, 240, "OV2640_RIGHT", 16, 0);
	...
	while (1)
	{
		...
		// 		Microphone_flag = 0;
		// 		voice_flag = 0;
		// 		Show_Str(30, 150, 220, 240, "123456789E", 16, 0);
		// 	}
		// 	else if (Microphone_flag == 0)
		// 	{
		// 		// 开启麦克风
		// 		voice_flag = 1;
		// 		wav_recorder();
		...
		// 		LCD_Fill(20, 145, 220, 240, YELLOW);  // 中间的背景色
		// 		LCD_DrawRectangle(20, 145, 220, 240); // 框框
		// 		Show_Str(30, 150, 220, 240, "WK_UP:PLAY/PAUSE", 16, 0);
		// 	}
