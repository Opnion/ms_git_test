 ...
 * @LastEditTime: 2024-01-06 01:06:35
 * @FilePath: \code\HARDWARE\WS2812B\WS2812B.c
 *
...
void RGB_LED_Init(void)
{
	...
	RGB_LED_Write_24Bits(0,0,0,0,0,0);//两个红 
	RGB_LED_Write_24Bits(0,0,225,0,0,225);//两个红 
}
...
void RGB_LED_Red(void)
{
	...
	for (i = 0; i < 1; i++)
	{
		RGB_LED_Write_24Bits(0, 0xff, 0, 0, 0, 0);
	}
}
...
void RGB_LED_Green(void)
{
	...
	for (i = 0; i < 1; i++)
	{
		RGB_LED_Write_24Bits(0xff, 0, 0, 0, 0, 0);
	}
}
...
void RGB_LED_Blue(void)
{
	...
	for (i = 0; i < 1; i++)
	{
		RGB_LED_Write_24Bits(0, 0, 0xff, 0, 0, 0);
	}
}
